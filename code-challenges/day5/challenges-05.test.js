...
const listFoods = (recipe) => {
  let result = [];
  let stringArrayTest = ['Gruffalo','oats','brown sugar','flour','pure maple syrup','chopped nuts', 'baking soda', 'baking powder', 'cinnamon', 'melted butter', 'fresh water'];

  for (let i=0; recipe.ingredients.length; i++){
    let index = recipe.ingredients[i].indexOf(stringArrayTest[i]);
